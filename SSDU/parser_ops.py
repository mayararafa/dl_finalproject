...
def get_parser():
    ...
    parser.add_argument('--reg_model', type=str, default="unet", choices=("resnet", "unet"),
                        help='which model to use for regularization network')
    ...
    parser.add_argument('--challenge', type=str, default="multicoil", choices=("singlecoil", "multicoil"),
