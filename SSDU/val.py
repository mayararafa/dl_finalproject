...
for epoch in np.linspace(10, 100, 10, dtype=np.int):
    ...
    save_plt_fname = "{}_{}_epoch{}.png".format(args.challenge, kspace_dir.split('/')[-1].split('.')[0], epoch)
...
ax.scatter(np.linspace(10, 100, 10), psnr_per_epoch, c='b', label='PSNR')
ax.scatter(np.linspace(10, 100, 10), ssim_per_epoch, c='r', label='SSIM')
ax.scatter(np.linspace(10, 100, 10), nmse_per_epoch, c='g', label='NMSE')
